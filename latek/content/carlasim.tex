...
\refstruc{fig:carlacoords}: X coordinate is to the front of the ego actor, Y is to the
...
depthmap camera and other simple ones such as collision detector. \refstruc{fig:carlaseg}
