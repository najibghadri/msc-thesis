...
\refstruc{fig:carla}) that is a quite mature and fully opensource project
...
In \autoref{chap:sensors} I give an overview of the 
widely used sensors for peception in the automotive industry: RGB cameras, radar,
Lidar and ultrasonic sensors.
In \autoref{chap:perceptions} I talk about different kinds of perceptions,
...
\autoref{chap:simulators} I describe the CARLA simulator and compare it with
other simulators.
